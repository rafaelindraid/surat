...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0 text-dark">Laporan Pengiriman Surat</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Daftar Pengiriman Surat</h3>
                        </div>    
                    <div class="card-body">
                                ...
                                <tr>
                                 ...
                                 <div class="panel-body">
                                  <label>Filter Berdasarkan Tanggal :</label>
                                    ...
                                    <label for="filter-periode"> Filter Berdasarkan Expedisi : </label>
                                    <select name="filter_periode" id="filter_periode" class="form-control">
